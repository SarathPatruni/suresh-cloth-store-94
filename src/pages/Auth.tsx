    ...
    <div className="min-h-screen flex flex-col bg-hero-gradient">
      ...
      <main className="flex-1 container py-8 md:py-10">
        ...
        <div className="max-w-6xl mx-auto mb-6 md:mb-8 flex items-center justify-between gap-4">
          ...
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-accent transition-elegant rounded-full border border-border/60 px-4 py-2 hover:border-accent/60"
          ...
          <div className="w-full max-w-md mx-auto lg:mx-0 lg:ml-auto h-full flex flex-col justify-center lg:py-10">
            ...
            <div className="bg-card/80 backdrop-blur p-7 md:p-8 rounded-xl">
              ...
              <div className="relative my-5">
                ...
                <span className="relative flex justify-center text-[0.65rem] uppercase tracking-[0.3em] text-muted-foreground bg-card/80 px-3">
                  or continue with
                </span>
              </div>
              ...
              >
                <svg viewBox="0 0 24 24" className="w-4 h-4" aria-hidden>
                  <path fill="#EA4335" d="M12 10.2v3.96h5.52c-.24 1.44-1.68 4.2-5.52 4.2-3.32 0-6.04-2.76-6.04-6.16S8.68 6.04 12 6.04c1.88 0 3.16.8 3.88 1.48l2.64-2.56C16.92 3.44 14.68 2.5 12 2.5 6.76 2.5 2.5 6.76 2.5 12S6.76 21.5 12 21.5c6.92 0 9.5-4.84 9.5-7.32 0-.5-.04-.88-.12-1.28H12z"/>
                </svg>
